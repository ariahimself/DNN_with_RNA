...
def L2X(datatype, train = True):
	...
	preds2 = Dense(2, activation='softmax', name = 'g2/dense4',
		kernel_regularizer=regularizers.l2(1e-3))(net3)
	...
	if train:
		...
		model.fit(x_train, [y_train, y_train], validation_data=(x_val, [y_val, y_val]),callbacks = callbacks_list, epochs=2, batch_size=BATCH_SIZE)
		st2 = time.time()
	else:
